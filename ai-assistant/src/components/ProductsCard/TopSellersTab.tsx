...
export const TopSellersTab: FC = () => {
    return (
        <div className='flex flex-col gap-[12px]'>
            {topSellersList.map((topSeller, idx) => {
                return (
                    <div key={topSeller.id}>
                        <div className='flex items-center px-2 py-2 rounded-[12px] transition-colors duration-200 cursor-pointer hover:bg-regaliaPurple'>
