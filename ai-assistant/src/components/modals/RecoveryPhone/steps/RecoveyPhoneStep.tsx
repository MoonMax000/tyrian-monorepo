...
import { TSteps } from '../RecoveyPhone';
...
export const ChangePhoneStep: FC<ChangePhoneStepProps> = ({ setStep, onClose, setPhone }) => {
  ...
  return (
    <div className='h-full flex flex-col items-start justify-start'>
      <h2 className='font-semibold text-2xl mb-6'>Add Recovery Phone Number</h2>
      <p className='text-[15px] text-lighterAluminum font-normal mb-6'>
        Add a backup phone number to recover your account via SMS in case you lose access.
      </p>
      <form
