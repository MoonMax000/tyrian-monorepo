...
export function MyPurchasesShortCard() {
  return (
    <div className='container-card flex flex-col p-4 rounded-[24px] gap-6 max-w-[100%]'>
      ...
      <div className='grid grid-cols-[15%_35%_15%_15%_auto] gap-y-4 text-[15px] font-[700]'>
          ...
          <React.Fragment key={i}>
            ...
            <div className='flex items-center'>
              <IndicatorTag
                ...
                type={row.status === 'Trial' ? 'darckGreen' : 'orange'}
              >
                {row.status}
              </IndicatorTag>
            </div>
