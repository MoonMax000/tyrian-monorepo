...
const navElements: NavElementProps[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: <Bot className="h-4 w-4" />, title: 'Dashboard', route: '/dashboard' },
      { icon: <Bot className="h-4 w-4" />, title: 'Profile', route: '/profile' },
      { icon: <Bot className="h-4 w-4" />, title: 'Settings', route: '/settings' },
      { icon: <Bot className="h-4 w-4" />, title: 'Security', route: '/security' },
      { icon: <Bot className="h-4 w-4" />, title: 'Billing', route: '/billing' },
      { icon: <Bot className="h-4 w-4" />, title: 'Referrals', route: '/referrals' },
      { icon: <Bot className="h-4 w-4" />, title: 'API', route: '/api' },
    ],
  },
  {
