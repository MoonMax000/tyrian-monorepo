...
import OpenNavbarButton from '@/assets/icons/navbar/OpenNavbarButton.svg';
...
const Navbar: React.FC<NavbarProps> = ({ variant = 'primal', className }) => {
  ...
  return (
    ...
    >
      <button
        className={cn(
          'absolute right-[-24px] top-4 z-50 flex h-[44px] w-[44px] items-center justify-center rounded-[8px] border border-[#523A83] bg-[#0B0E11] p-0 text-[#B0B0B0] transition hover:bg-[#181B20]',
        )}
