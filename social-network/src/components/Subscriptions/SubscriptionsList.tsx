...
import { useGetFollowingQuery, useGetUserFollowingQuery } from '@/store/api';
...
const SubscriptionsList: React.FC<Props> = ({ userId }) => {
  ...
  const {
    ...
    refetch,
  } = userId === ownId || !userId ? useGetFollowingQuery() : useGetUserFollowingQuery(userId);
  ...
  return (
    <div className='flex flex-col m-auto gap-6'>
      ...
      ) : followingData?.data && followingData.data.length ? (
              ...
              <div className='flex w-full items-center justify-between text-[12px] h-11'>
                ...
                <div className='flex gap-6 items-center'>
                  ...
                  <div className='flex gap-4'>
                    ...
                    <SubscribeButton userId={user.id} onClick={refetch} />
                  </div>
                </div>
              </div>
            </div>
