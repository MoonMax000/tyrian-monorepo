...
const navElements: NavElementProps[] = [
  ...
  },
  {
    ...
    route: '/',
    children: [
      { icon: <Users className="h-4 w-4" />, title: 'Feed (Home)', route: '/' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Popular', route: '/popular' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'New', route: '/new' },
      { icon: <Users className="h-4 w-4" />, title: 'Discussed', route: '/discussed' },
      { icon: <Users className="h-4 w-4" />, title: 'Favorites', route: '/favorites' },
      { icon: <Users className="h-4 w-4" />, title: 'For Us', route: '/for-us' },
      { icon: <Users className="h-4 w-4" />, title: 'Ideas', route: '/ideas' },
      { icon: <Users className="h-4 w-4" />, title: 'Scripts', route: '/scripts' },
      { icon: <Users className="h-4 w-4" />, title: 'Videos', route: '/video' },
      { icon: <Users className="h-4 w-4" />, title: 'Chats', route: '/chats' },
      { icon: <Users className="h-4 w-4" />, title: 'Settings', route: '/settings' },
    ],
  },
  {
