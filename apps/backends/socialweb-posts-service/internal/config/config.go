...
type Config struct {
	...
	HttpPort  uint16 `default:"8004" envconfig:"HTTP_PORT"`
	...
	EsUSER      string `default:"elastic" envconfig:"ES_USER"`
	EsPASSWORD  string `default:"admin123" envconfig:"ES_PASSWORD"`
	EsPORT      string `default:"9200" envconfig:"ES_PORT"`
	EsCONTAINER string `default:"elasticsearch" envconfig:"ES_CONTAINER"`
...
func LoadConfig() Config {
	...
	return Config{
		LogLevel:  logLevel,
		HttpPort:  internal.ParseUint16(os.Getenv("HTTP_PORT"), 8004),
		...
		EsPASSWORD:  getEnv("ES_PASSWORD", "admin123"),
		EsPORT:      getEnv("ES_PORT", "9200"),
		EsCONTAINER: getEnv("ES_CONTAINER", "elasticsearch"),
	}
}
