...
# This is for redirection after wrong confirmation action from email
...
# Users service api url (example: http://31.131.255.218:8080/api)
USER_SERVICE_BASE_URL=http://31.131.255.218:8080/api

RMQ_CONN_URL=amqp://guest:guest@rabbitmq:5672/
RMQ_MAIL_EXCHANGE=mail
# If true or yeas or y or 1 enable autocreate queue if queue doesn't exists
