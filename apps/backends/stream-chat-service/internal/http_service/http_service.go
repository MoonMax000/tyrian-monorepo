...
import (
	...
	"github.com/Capstane/stream-chat-service/internal/handler"
	"github.com/Capstane/stream-chat-service/internal/router"
...
func startHttpService(cfg *config.Config) {
	_, db, err := database.InitDatabase(cfg)
