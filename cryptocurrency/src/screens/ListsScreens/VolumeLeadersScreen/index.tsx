...
const VolumeLeadersScreen = () => {
  const { data: coins, isFetching } = useGetListingLatestQuery({ limit: 20, sort: 'volume_24h' });
  ...
  return (
    <Container>
      <div className='flex justify-between mt-[48px]'>
        <h1 className='text-h2 leading-[100%]'>Volume Leaders</h1>
      </div>
...
export default VolumeLeadersScreen;
