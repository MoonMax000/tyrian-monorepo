...
const MostVolatileCoinsScreen = () => {
  const { data: coins, isFetching } = useGetListingLatestQuery({
    limit: 20,
  ...
  return (
    <Container>
      <div className='flex justify-between mt-[48px]'>
        <h1 className='text-h2 leading-[100%]'>Most Volatile Coins</h1>
      </div>
...
export default MostVolatileCoinsScreen;
