...
const navElements: NavElementProps[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: <Bitcoin className="h-4 w-4" />, title: 'All Crypto', route: '/crypto' },
      { icon: <Bitcoin className="h-4 w-4" />, title: 'Portfolios', route: '/portfolios' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Gainers & Losers', route: '/gainers-and-losers' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Recently Added', route: '/recently-added' },
      { icon: <Calendar className="h-4 w-4" />, title: 'Calendar', route: '/calendar' },
