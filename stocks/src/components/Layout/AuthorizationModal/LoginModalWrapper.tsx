...
import LogoIcon from '@/assets/icons/redisign-logo.svg';
    ...
    login: {
      ...
      footerText: (
        <p className='mt-4 text-center flex gap-1 font-semibold'>
          <span className='opacity-[48%] font-bold text-body-15'>Not registered yet?</span>
          <span
  ...
  return (
    <div className='grid grid-cols-2 items-center w-full max-w-[768px] mx-auto bg-blackedGray rounded-[16px]'>
      <div className='px-6 py-[70px]'>
        {type && (
          <>
            <h4 className='text-h4 text-center mb-6'>{pageData[type].title}</h4>
            <div>
      ...
      >
        <div className='w-[100px] mx-auto mb-12'>
          <LogoIcon width={100} height={128} alt='logo' />
        </div>
