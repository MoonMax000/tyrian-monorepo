...
export const navItemsList: Record<LayoutVariant, NavItem[]> = {
    ...
    { id: '5', label: 'Research', icon: <Research /> },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { id: '9', label: 'Fear and Greed', icon: <FearAndGreed />, href: 'http://localhost:4203/fear-and-greed' },
            { id: '10', label: 'Altseason Index', icon: <AltSeasonIndex />, href: 'http://localhost:4203/alt-season' },
            { id: '11', label: 'BTC Dominance', icon: <BTCDominance />, href: 'http://localhost:4203/btc-dominance' },
            { id: '12', label: 'Top Gainers', href: 'http://localhost:4203/lists/top-gainers' },
            { id: '13', label: 'Top Losers', href: 'http://localhost:4203/lists/top-losers' },
            { id: '14', label: 'Volume Leaders', href: 'http://localhost:4203/lists/volume-leaders' },
          ],
        },
        { 
          id: '15', 
          ...
          icon: <SocialNetwork />, 
          href: 'http://localhost:4204',
          children: [
            { id: '151', label: 'New Posts', href: 'http://localhost:4204/new' },
            { id: '152', label: 'Popular', href: 'http://localhost:4204/popular' },
            { id: '153', label: 'For You', href: 'http://localhost:4204/for-us' },
            { id: '154', label: 'Ideas', href: 'http://localhost:4204/ideas' },
            { id: '155', label: 'Discussed', href: 'http://localhost:4204/discussed' },
            { id: '156', label: 'Favorites', href: 'http://localhost:4204/favorites' },
            { id: '157', label: 'Chats', href: 'http://localhost:4204/chats' },
          ],
        },
        { 
          id: '16', 
          label: 'Marketplace', 
          icon: <MarketPlace />, 
          href: 'http://localhost:4205',
          children: [
            { id: '161', label: 'Signals & Indicators', href: 'http://localhost:4205/signals-tab' },
            { id: '162', label: 'Strategies', href: 'http://localhost:4205/strategies-tab' },
            { id: '163', label: 'Robots & Algorithms', href: 'http://localhost:4205/robots-tab' },
            { id: '164', label: 'Consultants', href: 'http://localhost:4205/consultants-tab' },
            { id: '165', label: 'Traders', href: 'http://localhost:4205/traders-tab' },
            { id: '166', label: 'Analysts', href: 'http://localhost:4205/analystys-tab' },
            { id: '167', label: 'Scripts', href: 'http://localhost:4205/scripts-tab' },
            { id: '168', label: 'Courses', href: 'http://localhost:4205/courses-tab' },
            { id: '169', label: 'Popular', href: 'http://localhost:4205/popular-tab' },
            { id: '170', label: 'Favorites', href: 'http://localhost:4205/favorites-tab' },
          ],
        },
    ...
    },
  {
    ...
    children: [
      ...
      { id: '15', label: 'Social Network', icon: <SocialNetwork />, href: 'http://localhost:4204', children: [] },
      { id: '16', label: 'Marketplace', icon: <MarketPlace />, href: 'http://localhost:4205', children: [] },
