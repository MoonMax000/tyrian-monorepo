...
const columns: IColumn<{
  ...
  { key: 'duration', label: 'Period', rowClassName: 'text-left', columnClassName: 'text-left' },
  {
    key: 'last_date',
  ...
  },
  {
    ...
    rowClassName: 'text-center',
    columnClassName: 'text-center',
    renderCell: ({ profitability }) => `${profitability}%`,
  },
];
    ...
    <Table
      ...
      topContent={
        <div className='flex items-center gap-x-2 py-6 px-4'>
          <h2 className='text-white font-bold text-[24px]'>Dividend History</h2>
