...
const navElements: NavElementProps[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: <Video className="h-4 w-4" />, title: 'Recommended', route: '/recommended' },
      { icon: <Video className="h-4 w-4" />, title: 'Following', route: '/following' },
      { icon: <Video className="h-4 w-4" />, title: 'Browse Streams', route: '/browse' },
      { icon: <Video className="h-4 w-4" />, title: 'My Channel', route: '/channel' },
