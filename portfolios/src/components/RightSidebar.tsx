...
export const RightSidebar: FC<Props> = ({ isOpen }) => {
  return (
    <section
      className={cn(
        "relative z-20 flex flex-col gap-6 overflow-hidden transition-all duration-500 ease-in-out",
        {
          "h-0 w-0 p-0 opacity-0": !isOpen,
          "w-[312px] pr-6 opacity-100": isOpen,
        },
      )}
    >
      {/* Trading Psychology Card */}
      <div className="flex w-[312px] p-4 flex-col items-start rounded-xl border border-[#181B22] bg-[rgba(11,14,17,0.50)] backdrop-blur-[50px]">
