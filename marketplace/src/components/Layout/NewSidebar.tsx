...
const navElements: NavElementProps[] = [
  { icon: <Home className="h-5 w-5" />, title: 'Home', route: '/' },
  {
    ...
    children: [
      { icon: <Home className="h-4 w-4" />, title: 'Home', route: 'http://localhost:3002/' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Crypto Currency', route: 'http://localhost:3002/crypto-currency' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Portfolios', route: 'http://localhost:3002/portfolios' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'My Portfolios', route: 'http://localhost:3002/my-portfolios' },
      { icon: <Calendar className="h-4 w-4" />, title: 'Dividends Schedule', route: 'http://localhost:3002/dividends-schedule' },
      { icon: <Calendar className="h-4 w-4" />, title: 'Events Calendar', route: 'http://localhost:3002/events-calendar' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Market News', route: 'http://localhost:3002/market-news' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Research', route: 'http://localhost:3002/research' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Stocks Comparison', route: 'http://localhost:3002/stocks-comparison' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Volatility', route: 'http://localhost:3002/volatility' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Volume', route: 'http://localhost:3002/volume' },
      { icon: <Users className="h-4 w-4" />, title: 'Profile', route: 'http://localhost:3002/profile' },
    ],
  },
  {
  ...
  },
  {
    ...
    route: 'http://localhost:4204',
    children: [
      { icon: <Users className="h-4 w-4" />, title: 'Feed (Home)', route: 'http://localhost:4204/' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'Popular', route: 'http://localhost:4204/popular' },
      { icon: <TrendingUp className="h-4 w-4" />, title: 'New', route: 'http://localhost:4204/new' },
      { icon: <Users className="h-4 w-4" />, title: 'Discussed', route: 'http://localhost:4204/discussed' },
      { icon: <Users className="h-4 w-4" />, title: 'Favorites', route: 'http://localhost:4204/favorites' },
      { icon: <Users className="h-4 w-4" />, title: 'For Us', route: 'http://localhost:4204/for-us' },
      { icon: <Users className="h-4 w-4" />, title: 'Ideas', route: 'http://localhost:4204/ideas' },
      { icon: <Users className="h-4 w-4" />, title: 'Scripts', route: 'http://localhost:4204/scripts' },
      { icon: <Users className="h-4 w-4" />, title: 'Videos', route: 'http://localhost:4204/video' },
      { icon: <Users className="h-4 w-4" />, title: 'Chats', route: 'http://localhost:4204/chats' },
      { icon: <Users className="h-4 w-4" />, title: 'Settings', route: 'http://localhost:4204/settings' },
    ],
  },
  {
