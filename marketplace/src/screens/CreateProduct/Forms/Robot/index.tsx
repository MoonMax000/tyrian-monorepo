    ...
    <div className='flex flex-col gap-6 pb-60'>
      <div className='z-[100] custom-bg-blur border border-regaliaPurple rounded-[24px]'>
        ...
        <div className='p-4 flex flex-col gap-4'>
          ...
          <Input label='RUNNING TIME' placeholder='1d 1h 1m' />
          <Input label='ROI APY FOR 30 DAYS' placeholder='+10.00%' />
          <Input label='ROI APY FOR 1 YEAR' placeholder='+10.00%' />
          <Input label='AUM (USDT)' placeholder='100,000.00' />
          <Input label='PLATFORM' placeholder='Windows/Mac OS' />
          <Input label='SECTOR' placeholder='Crypto, Forex, Stocks, etc...' />
