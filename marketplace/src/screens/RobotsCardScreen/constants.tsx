...
export const mockRobotDescription = {
  robotName: 'Grid-Bot HODL',
  description: `Automates swaps between Ethereum (ETH) and Bitcoin (BTC) based on price divergence. 
  When ETH outperforms BTC the bot sells a slice of ETH for BTC; when BTC regains strength the cycle reverse. 
  No manual action required. Automates swaps between Ethereum (ETH) and Bitcoin (BTC) based on price divergence. 
  When ETH outperforms BTC the bot sells a slice of ETH for BTC; when BTC regains strength the cycle reverse. 
  No manual action required.Automates swaps between Ethereum (ETH) and Bitcoin (BTC) based on price divergence. 
  When ETH outperforms BTC the bot sells a slice of ETH for BTC; when BTC regains strength the cycle reverse. 
...
export const mockDetails = {
  user: {
    name: 'John Smith',
    avatar: '/avatars/profile.svg',
    role: 'Individual Analyst',
  },
  runningDate: '2025-02-17T13:47:59.903334',
  roiMonth: 120.83,
  roiYear: 520,
  subscribers: 4071,
  aum: 216632.59,
