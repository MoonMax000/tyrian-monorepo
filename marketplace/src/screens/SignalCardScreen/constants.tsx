...
import expertAvatarImg from '@/assets/mock-profile-avatar-squared.png';
...
export const mockSpecifications = {
  ...
  risk: 'Low, max 10% draw-down',
  signals: '5-10 per week',
  stats: 'ROI chart, 311 subs, rating 4.5/5, lats signals available',
};
